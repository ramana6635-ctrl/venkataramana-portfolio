  ...
  return <div className="min-h-screen bg-background text-foreground">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-6">
                <div className="glass p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-mono neon-text">3</p>
                </div>
                <div className="glass p-4 rounded-lg">
                  <h4 className="font-semibold text-secondary mb-2">Projects Completed</h4>
                  <p className="text-2xl font-mono neon-text">2</p>
                </div>
                <div className="glass p-4 rounded-lg">
      ...
      <section id="skills" className="py-20 px-6 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {Object.entries(skills).map(([category, skillList]) => <div key={category} className="glass-card">
                <h3 className="text-xl font-bold mb-6 text-primary capitalize">
                  {category}
                </h3>
                <div className="space-y-4">
                  {skillList.map((skill, index) => <div key={skill} className="space-y-2">
      ...
      <section id="projects" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => <div key={project.title} className="glass-card group">
                <div className="mb-4">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map(tech => <span key={tech} className="glass px-3 py-1 rounded-full text-sm font-mono text-accent">
                        {tech}
                      </span>)}
                  </div>
                </div>
      ...
      <section id="blog" className="py-20 px-6 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => <article key={post.title} className="glass-card">
                <h3 className="text-xl font-bold mb-3 text-primary">
                  {post.title}
                </h3>
                <p className="text-muted-foreground mb-4">
                ...
                <a href={post.readMore} className="inline-flex items-center text-secondary hover:text-primary transition-colors">
                  Read More
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" id="name" name="name" value={formData.name} onChange={handleInputChange} className="glass-input" placeholder="Your Name" required />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm font-medium mb-2 text-primary">
                    Email
                  </label>
                  <input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange} className="glass-input" placeholder="your@email.com" required />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea id="message" name="message" rows={5} value={formData.message} onChange={handleInputChange} className="glass-input resize-none" placeholder="Your message..." required></textarea>
              </div>
              
              <div className="text-center">
                <a href={`mailto:alex.chen@example.com?subject=Portfolio Contact&body=${formData.message}`} className="btn-neon inline-flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-12 px-6 bg-muted/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6">
            ...
            label: 'Email'
          }].map(social => <a key={social.icon} href={social.url} className="glass p-4 rounded-full neon-glow hover:scale-110 transition-all duration-300" aria-label={social.label}>
